...
function ct_custom_scripts() {
	wp_enqueue_style( 'boostrap5', get_template_directory_uri() .'/assets/bootstrap/bootstrap.min.css');
	wp_enqueue_style( 'ct-custom-style', get_stylesheet_uri() );
	wp_enqueue_style( 'default_theme_layout', get_template_directory_uri().'/default_theme.css');
	wp_enqueue_script('boostrap5JS', get_template_directory_uri() .'/assets/bootstrap/bootstrap.bundle.min.js');
